...
export default defineConfig(({ mode }) => ({
  base: "/skyvault2/", // Adjusted for GitHub Pages
  define: {
    ...
    "import.meta.env.VITE_SUPABASE_PUBLISHABLE_KEY": JSON.stringify(
      process.env.VITE_SUPABASE_PUBLISHABLE_KEY ??
        "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6IndpYXd0cGxwbWV6c2Rsem53emdyIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NzY4MDQ1MjgsImV4cCI6MjA5MjM4MDUyOH0.5al0SvyBku-au81spverrZ..."
    ),
  },
  server: {
    host: "::",
